...
function FloatingPaths({
    ...
    const paths = React.useMemo(() => Array.from({ length: 20 }, (_, i) => ({
        id: i,
    ...
    return (
        <div className="absolute inset-0 pointer-events-none [contain:layout_paint]">
            <svg
...
export function BackgroundPaths({
    ...
    return (
        <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-white dark:bg-neutral-950 [contain:layout_paint]">
