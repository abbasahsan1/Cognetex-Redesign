            ...
            {courses.map((course) => (
              ...
              >
                ...
                <div className="flex justify-between items-start mb-2">
                  <h3 className="text-2xl md:text-3xl font-bold text-foreground tracking-tight group-hover:text-signal transition-colors">
                    {course.title}
                  </h3>
                  <span className="text-xs font-mono font-bold text-signal">{course.price}</span>
                </div>
